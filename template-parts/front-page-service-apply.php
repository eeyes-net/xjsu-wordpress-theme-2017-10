<div class="service-tab apply active" id="apply">
            ...
            <div class="main-section-list-block">
                <a href="<?php the_permalink(); ?>" target="_blank">
                    <div class="main-section-list-content">
                        ...
                        <div class="main-section-list-info"><?php the_excerpt(); ?><?php echo get_the_date(); ?></div>
                    </div>
                </a>
            </div>
			<?php
    ...
    <div class="service-tab-more">
        <a class="service-tab-more-button" href="<?php echo get_category_link( get_category_by_slug( 'apply' ) ); ?>">
